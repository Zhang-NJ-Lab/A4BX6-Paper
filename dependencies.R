source('~/Desktop/ZhengPan/Programming/R/code collection/R/ML/pearson.R')
source('~/Desktop/ZhengPan/Programming/R/code collection/R/ML/feature_selection.R')
source('~/Desktop/ZhengPan/Programming/R/code collection/R/ML/filter.R')
source('~/Desktop/ZhengPan/Programming/R/code collection/R/ML/writePrediction.R')
  ...
  res1 <- autoplot(prediction) +
    ...
    annotate("text",
             ...
             label = c(TeX(paste0("Pearson's r: ",pr)), 
                       fancy_scientific(paste0("RMSE: ",rmse)),
